...
# Iteration Version: Ver 0.8 - Nearing Full Game Completion
...
###
# We could use stack, but doing so would mean having to allowcate upwards of 15 entries into the .data section.
# Heap may also be used, but I believe it falls into the same issue.
# Perhaps a jal to a dedicated stack function that loops RN Generation
# Reserved Space for Minefield Generation # Might need to dedicate
#	la		$t0, frameBuffer	# Loads frameBuffer
#	addi		$t1, $zero,48		# $t1 = 48 Being the Length of a row, - 4 pixels from the row
